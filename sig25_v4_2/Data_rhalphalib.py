...
#    msdbins = np.linspace(0, 100, 21)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (5, 5), ['pt', 'rho'], init_params=initial_vals, limits=(-10, 10))
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (5, 5), ['pt', 'rho'], limits=(-10, 10))
