...
#    msdbins = np.linspace(0, 100, 21)
    ...
    initial_vals = initial_vals.reshape(8, 8)
    print(initial_vals)

    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (7, 7), ['pt', 'rho'], init_params=initial_vals, limits=(-10, 10))
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (7, 7), ['pt', 'rho'], limits=(-10, 10))
