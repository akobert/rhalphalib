...
#    msdbins = np.linspace(0, 100, 21)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (6, 6), ['pt', 'rho'], init_params=initial_vals, limits=(-10, 10))
    ...
    print("RooFit Success")	
    print("Fit Status: "+str(Datafit.status()))	
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (6, 6), ['pt', 'rho'], limits=(-10, 10))
