...
def drawDiagnostic(name, ifile1):
	gROOT.SetBatch(True)
	Sigs = [["/home/akobert/CMSSW_11_1_0_pre7/src/RData/signalMC/RData_25GeV_20.root"], "5.9*7639.0/567896.0", "", "sig25_v3", "25 GeV Signal", "7639.0"]
	sig_name = "sig25_v3"
...
#					C2e.Print("results/"+NAME+"/Sig2D_"+P+".png")
					...
					pull.Draw("esame")
					p22.RedrawAxis()
					C.Print("results/"+NAME+"/"+savename+"_"+pf+str(a)+"_v3.root")
					C.Print("results/"+NAME+"/"+savename+"_"+pf+str(a)+"_v3.png")
