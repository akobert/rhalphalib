...
class Build:
	def __init__(self, name, bfile1, bfile3, dfile1, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, sfile7, sfile8):
		gROOT.SetBatch(True)
		...
		#Pass and Fail accidentally swapped
		self.Data_p7_w = self.f.Get("jet_pt_soft_fail_wide3")
		...
		#Pass and Fail accidentally swapped (should switch back in future)
		self.Data_f7_w = self.f.Get("jet_pt_soft_pass_wide3")
		...
		self.h = TFile.Open(bfile1, "READ")
		self.h.ls();

		#Pass and Fail accidentally swapped (should switch back in future)
		self.GJ_p7_w = self.h.Get("jet_pt_soft_fail_wide3")
		self.GJ_f7_w = self.h.Get("jet_pt_soft_pass_wide3")
		...
		#Pass and Fail accidentally swapped (should switch back in future)
		self.TTBar_p7_w = self.g.Get("jet_pt_soft_fail_wide3")
		...
		self.TTBar_f7_w = self.g.Get("jet_pt_soft_pass_wide3")
		...
		self.sig1_p7_w = self.s1.Get("jet_pt_soft_pass_wide3")
		self.sig1_f7_w = self.s1.Get("jet_pt_soft_fail_wide3")
		
		self.s2 = TFile(sfile2, "READ")
		self.sig2_p7 = self.s2.Get("jet_pt_soft_pass")
		self.sig2_f7 = self.s2.Get("jet_pt_soft_fail")
		self.sig2_p7_w = self.s2.Get("jet_pt_soft_pass_wide3")
		self.sig2_f7_w = self.s2.Get("jet_pt_soft_fail_wide3")
		
		self.s3 = TFile(sfile3, "READ")
		self.sig3_p7 = self.s3.Get("jet_pt_soft_pass")
		self.sig3_f7 = self.s3.Get("jet_pt_soft_fail")
		self.sig3_p7_w = self.s3.Get("jet_pt_soft_pass_wide3")
		self.sig3_f7_w = self.s3.Get("jet_pt_soft_fail_wide3")
		
		self.s4 = TFile(sfile4, "READ")
		self.sig4_p7 = self.s4.Get("jet_pt_soft_pass")
		self.sig4_f7 = self.s4.Get("jet_pt_soft_fail")
		self.sig4_p7_w = self.s4.Get("jet_pt_soft_pass_wide3")
		self.sig4_f7_w = self.s4.Get("jet_pt_soft_fail_wide3")
		
		self.s5 = TFile(sfile5, "READ")
		self.sig5_p7 = self.s5.Get("jet_pt_soft_pass")
		self.sig5_f7 = self.s5.Get("jet_pt_soft_fail")
		self.sig5_p7_w = self.s5.Get("jet_pt_soft_pass_wide3")
		self.sig5_f7_w = self.s5.Get("jet_pt_soft_fail_wide3")
		
		self.s6 = TFile(sfile6, "READ")
		self.sig6_p7 = self.s6.Get("jet_pt_soft_pass")
		self.sig6_f7 = self.s6.Get("jet_pt_soft_fail")
		self.sig6_p7_w = self.s6.Get("jet_pt_soft_pass_wide3")
		self.sig6_f7_w = self.s6.Get("jet_pt_soft_fail_wide3")
		
		self.s7 = TFile(sfile7, "READ")
		self.sig7_p7 = self.s7.Get("jet_pt_soft_pass")
		self.sig7_f7 = self.s7.Get("jet_pt_soft_fail")
		self.sig7_p7_w = self.s7.Get("jet_pt_soft_pass_wide3")
		self.sig7_f7_w = self.s7.Get("jet_pt_soft_fail_wide3")
		
		self.s8 = TFile(sfile8, "READ")
		self.sig8_p7 = self.s8.Get("jet_pt_soft_pass")
		self.sig8_f7 = self.s8.Get("jet_pt_soft_fail")
		self.sig8_p7_w = self.s8.Get("jet_pt_soft_pass_wide3")
		self.sig8_f7_w = self.s8.Get("jet_pt_soft_fail_wide3")


	
		#currently using 10% of data
		#Runs B and C have 14.04 fb -> 1.404 fb
		#59.9 fb -> 1.404 (Scale by .02344)

		self.TTBar_p1.Scale(.02344)
		self.TTBar_p2.Scale(.02344)
		self.TTBar_p3.Scale(.02344)
		self.TTBar_p4.Scale(.02344)
		self.TTBar_p5.Scale(.02344)
		self.TTBar_p6.Scale(.02344)
		self.TTBar_p7.Scale(.02344)
		self.TTBar_p7_w.Scale(.02344)
		self.TTBar_f1.Scale(.02344)
		self.TTBar_f2.Scale(.02344)
		self.TTBar_f3.Scale(.02344)
		self.TTBar_f4.Scale(.02344)
		self.TTBar_f5.Scale(.02344)
		self.TTBar_f6.Scale(.02344)
		self.TTBar_f7.Scale(.02344)
		self.TTBar_f7_w.Scale(.02344)
		self.TTBar_h1.Scale(.02344)
		self.TTBar_h2.Scale(.02344)
		
		self.GJ_p7_w.Scale(.02344)
		self.GJ_f7_w.Scale(.02344)

		self.sig1_p7.Scale(.02344)
		self.sig1_f7.Scale(.02344)
		self.sig1_p7_w.Scale(.02344)
		self.sig1_f7_w.Scale(.02344)
		self.sig2_p7.Scale(.02344)
		self.sig2_f7.Scale(.02344)
		self.sig2_p7_w.Scale(.02344)
		self.sig2_f7_w.Scale(.02344)
		self.sig3_p7.Scale(.02344)
		self.sig3_f7.Scale(.02344)
		self.sig3_p7_w.Scale(.02344)
		self.sig3_f7_w.Scale(.02344)
		self.sig4_p7.Scale(.02344)
		self.sig4_f7.Scale(.02344)
		self.sig4_p7_w.Scale(.02344)
		self.sig4_f7_w.Scale(.02344)
		self.sig5_p7.Scale(.02344)
		self.sig5_f7.Scale(.02344)
		self.sig5_p7_w.Scale(.02344)
		self.sig5_f7_w.Scale(.02344)
		self.sig6_p7.Scale(.02344)
		self.sig6_f7.Scale(.02344)
		self.sig6_p7_w.Scale(.02344)
		self.sig6_f7_w.Scale(.02344)
		self.sig7_p7.Scale(.02344)
		self.sig7_f7.Scale(.02344)
		self.sig7_p7_w.Scale(.02344)
		self.sig7_f7_w.Scale(.02344)
		self.sig8_p7.Scale(.02344)
		self.sig8_f7.Scale(.02344)
		self.sig8_p7_w.Scale(.02344)
		self.sig8_f7_w.Scale(.02344)
...
#		self.Data_f9.Rebin2D(2,1)
		...
		ofile.WriteObject(self.Data_p7_w, "Data_pass_jet_pt_soft_wide3")
		...
		ofile.WriteObject(self.Data_f7_w, "Data_fail_jet_pt_soft_wide3")
		...
		ofile.WriteObject(self.GJ_p7_w, "GJ_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.GJ_f7_w, "GJ_fail_jet_pt_soft_wide3")
		...
		ofile.WriteObject(self.TTBar_p7_w, "TTBar_pass_jet_pt_soft_wide3")
	#	ofile.WriteObject(self.TTBar_p9, "TTBar_pass_jet_pt_rho")
		...
		ofile.WriteObject(self.TTBar_f7_w, "TTBar_fail_jet_pt_soft_wide3")
	#	ofile.WriteObject(self.TTBar_f9, "TTBar_fail_jet_pt_rho")
		...
		ofile.WriteObject(self.sig1_p7_w, "Sig10_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig1_f7_w, "Sig10_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig2_p7, "Sig20_pass_jet_pt_soft")
		ofile.WriteObject(self.sig2_f7, "Sig20_fail_jet_pt_soft")
		ofile.WriteObject(self.sig2_p7_w, "Sig20_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig2_f7_w, "Sig20_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig3_p7, "Sig25_pass_jet_pt_soft")
		ofile.WriteObject(self.sig3_f7, "Sig25_fail_jet_pt_soft")
		ofile.WriteObject(self.sig3_p7_w, "Sig25_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig3_f7_w, "Sig25_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig4_p7, "Sig50_pass_jet_pt_soft")
		ofile.WriteObject(self.sig4_f7, "Sig50_fail_jet_pt_soft")
		ofile.WriteObject(self.sig4_p7_w, "Sig50_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig4_f7_w, "Sig50_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig5_p7, "Sig75_pass_jet_pt_soft")
		ofile.WriteObject(self.sig5_f7, "Sig75_fail_jet_pt_soft")
		ofile.WriteObject(self.sig5_p7_w, "Sig75_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig5_f7_w, "Sig75_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig6_p7, "Sig100_pass_jet_pt_soft")
		ofile.WriteObject(self.sig6_f7, "Sig100_fail_jet_pt_soft")
		ofile.WriteObject(self.sig6_p7_w, "Sig100_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig6_f7_w, "Sig100_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig7_p7, "Sig125_pass_jet_pt_soft")
		ofile.WriteObject(self.sig7_f7, "Sig125_fail_jet_pt_soft")
		ofile.WriteObject(self.sig7_p7_w, "Sig125_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig7_f7_w, "Sig125_fail_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig8_p7, "Sig150_pass_jet_pt_soft")
		ofile.WriteObject(self.sig8_f7, "Sig150_fail_jet_pt_soft")
		ofile.WriteObject(self.sig8_p7_w, "Sig150_pass_jet_pt_soft_wide3")
		ofile.WriteObject(self.sig8_f7_w, "Sig150_fail_jet_pt_soft_wide3")
		

		ROOT.gInterpreter.Declare("Double_t widebins3[15] = {0, 120, 135, 155, 175, 200, 250, 300, 400, 500, 700, 900, 1200, 1500, 2000};")
                h1 = TH2F("ratio", "Ratio of Pass/Fail Events in Jet pT vs. Softdrop Mass", 14, widebins3, 40, 0, 200)
