...
class Build:
	def __init__(self, name, bfile1, bfile3, dfile1, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, sfile7, sfile8):
		...
		self.GJ_p7_w = self.h.Get("jet_pt_soft_pass_wide4")
		self.GJ_f7_w = self.h.Get("jet_pt_soft_fail_wide4")
		...
		self.sig2_p7_w = self.s2.Get("jet_pt_soft_pass_wide4")
		self.sig2_f7_w = self.s2.Get("jet_pt_soft_fail_wide4")
		
		self.s3 = TFile(sfile3, "READ")
		self.sig3_p7 = self.s3.Get("jet_pt_soft_pass")
		self.sig3_f7 = self.s3.Get("jet_pt_soft_fail")
		self.sig3_p7_w = self.s3.Get("jet_pt_soft_pass_wide4")
		self.sig3_f7_w = self.s3.Get("jet_pt_soft_fail_wide4")
		
		self.s4 = TFile(sfile4, "READ")
		self.sig4_p7 = self.s4.Get("jet_pt_soft_pass")
		self.sig4_f7 = self.s4.Get("jet_pt_soft_fail")
		self.sig4_p7_w = self.s4.Get("jet_pt_soft_pass_wide4")
		self.sig4_f7_w = self.s4.Get("jet_pt_soft_fail_wide4")
		
		self.s5 = TFile(sfile5, "READ")
		self.sig5_p7 = self.s5.Get("jet_pt_soft_pass")
		self.sig5_f7 = self.s5.Get("jet_pt_soft_fail")
		self.sig5_p7_w = self.s5.Get("jet_pt_soft_pass_wide4")
		self.sig5_f7_w = self.s5.Get("jet_pt_soft_fail_wide4")
		
		self.s6 = TFile(sfile6, "READ")
		self.sig6_p7 = self.s6.Get("jet_pt_soft_pass")
		self.sig6_f7 = self.s6.Get("jet_pt_soft_fail")
		self.sig6_p7_w = self.s6.Get("jet_pt_soft_pass_wide4")
		self.sig6_f7_w = self.s6.Get("jet_pt_soft_fail_wide4")
		
		self.s7 = TFile(sfile7, "READ")
		self.sig7_p7 = self.s7.Get("jet_pt_soft_pass")
		self.sig7_f7 = self.s7.Get("jet_pt_soft_fail")
		self.sig7_p7_w = self.s7.Get("jet_pt_soft_pass_wide4")
		self.sig7_f7_w = self.s7.Get("jet_pt_soft_fail_wide4")
		
		self.s8 = TFile(sfile8, "READ")
		self.sig8_p7 = self.s8.Get("jet_pt_soft_pass")
		self.sig8_f7 = self.s8.Get("jet_pt_soft_fail")
		self.sig8_p7_w = self.s8.Get("jet_pt_soft_pass_wide4")
		self.sig8_f7_w = self.s8.Get("jet_pt_soft_fail_wide4")
...
#		self.Data_f9.Rebin2D(2,1)
	...
	#	ofile.WriteObject(self.TTBar_f9, "TTBar_fail_jet_pt_rho")
		...
		ofile.WriteObject(self.sig1_p7_w, "Sig10_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig1_f7_w, "Sig10_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig2_p7, "Sig20_pass_jet_pt_soft")
		ofile.WriteObject(self.sig2_f7, "Sig20_fail_jet_pt_soft")
		ofile.WriteObject(self.sig2_p7_w, "Sig20_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig2_f7_w, "Sig20_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig3_p7, "Sig25_pass_jet_pt_soft")
		ofile.WriteObject(self.sig3_f7, "Sig25_fail_jet_pt_soft")
		ofile.WriteObject(self.sig3_p7_w, "Sig25_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig3_f7_w, "Sig25_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig4_p7, "Sig50_pass_jet_pt_soft")
		ofile.WriteObject(self.sig4_f7, "Sig50_fail_jet_pt_soft")
		ofile.WriteObject(self.sig4_p7_w, "Sig50_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig4_f7_w, "Sig50_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig5_p7, "Sig75_pass_jet_pt_soft")
		ofile.WriteObject(self.sig5_f7, "Sig75_fail_jet_pt_soft")
		ofile.WriteObject(self.sig5_p7_w, "Sig75_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig5_f7_w, "Sig75_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig6_p7, "Sig100_pass_jet_pt_soft")
		ofile.WriteObject(self.sig6_f7, "Sig100_fail_jet_pt_soft")
		ofile.WriteObject(self.sig6_p7_w, "Sig100_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig6_f7_w, "Sig100_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig7_p7, "Sig125_pass_jet_pt_soft")
		ofile.WriteObject(self.sig7_f7, "Sig125_fail_jet_pt_soft")
		ofile.WriteObject(self.sig7_p7_w, "Sig125_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig7_f7_w, "Sig125_fail_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig8_p7, "Sig150_pass_jet_pt_soft")
		ofile.WriteObject(self.sig8_f7, "Sig150_fail_jet_pt_soft")
		ofile.WriteObject(self.sig8_p7_w, "Sig150_pass_jet_pt_soft_wide4")
		ofile.WriteObject(self.sig8_f7_w, "Sig150_fail_jet_pt_soft_wide4")
