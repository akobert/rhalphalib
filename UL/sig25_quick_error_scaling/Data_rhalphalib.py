...
def get_template(sName, passed, ptbin, obs, syst, muon=False):
    ...
    name = sName+'_'+name+'_'+"jet_pt_soft_wide3"
...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0,120,135,155,175,200,250,300,400,500,700,900,1200,1500,2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins[15] = {0, 120, 135, 155, 175, 200, 250, 300, 400, 500, 700, 900, 1200, 1500, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 14, widebins, 40, 0, 2000)
...
#        SF = json.load(f)
    ...
    # define bins    
    ptbins = np.array([120,135,155,175,200,250,300,400,500])
