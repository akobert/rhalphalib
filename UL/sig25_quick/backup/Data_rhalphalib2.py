...
#    msdbins = np.linspace(0, 100, 21)
    ...
    for ptbin in range(npt):
        ...
        failTempl = get_template('Data', 0, ptbin+2, obs=msd, syst='nominal') 
        passTempl = get_template('Data', 1, ptbin+2, obs=msd, syst='nominal') 
        
	TTfailTempl = get_template('TTBar', 0, ptbin+2, obs=msd, syst='nominal') 
        TTpassTempl = get_template('TTBar', 1, ptbin+2, obs=msd, syst='nominal') 
