...
combine -M FitDiagnostics output/testModel/model_combined.root --saveShapes --saveWithUncertainties --saveWorkspace --cminDefaultMinimizerStrategy 0 --robustFit=1 --plots -v 0
