...
import ROOT
import sys
sys.path[:0] = ["/home/akobert/.local/lib/python2.7/site-packages/"]
...
#        cat = 'ggf'
    ...
    plt.savefig(thisdir+"_data.png",bbox_inches='tight')
    plt.savefig(thisdir+"_data.pdf",bbox_inches='tight')
    plt.show()
