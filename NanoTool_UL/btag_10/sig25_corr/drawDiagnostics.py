      ...
      #                                  if P == "fit_b":
       #                                         print("fit_b Test sqrt: "+str(math.sqrt(bkg.GetBinContent(3))))
        #                                        print("fit_b Test Error: "+str(bkg.GetBinError(3)))
					...
					print("Type: "+pf+" "+P+" "+"ptbin"+str(a))
					for i in range(pull.GetNbinsX()):
						if not data.GetBinContent(i+1) == 0:
							print("Bin: "+str(i+1))
							print("Data: "+str(data.GetBinContent(i+1)))
							print("Background: "+str(bkg.GetBinContent(i+1)))
							print("Data Error: "+str(data.GetBinError(i+1)))
							print("Data-Background: "+str(pull.GetBinContent(i+1)))
							print("(Data-Background)/Error: "+str(pull.GetBinContent(i+1)/data.GetBinError(i+1)))
