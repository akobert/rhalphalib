...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0,120,130,145,160,180,200,250,300,400,500,700,900,1200,1500,2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins[16] = {0, 120, 130, 145, 160, 180, 200, 250, 300, 400, 500, 700, 900, 1200, 1500, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 15, widebins, 40, 0, 2000)
...
#        SF = json.load(f)
    ...
    # define bins    
    ptbins = np.array([120,130,145,160,180,200,250,300,400,500])
