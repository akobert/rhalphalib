...
#    msdbins = np.linspace(0, 50, 11)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (4, 4), ['pt', 'rho'], init_params=initial_vals, limits=(-500, 500))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (4, 4), ['pt', 'rho'], limits=(-500, 500))
