...
#    msdbins = np.linspace(0, 50, 11)
    ...
    initial_vals = initial_vals.reshape(7, 7)
    print(initial_vals)

    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (6, 6), ['pt', 'rho'], init_params=initial_vals, limits=(-1000, 1000))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (6, 6), ['pt', 'rho'], limits=(-1000, 1000))
