...
#    msdbins = np.linspace(0, 50, 11)
    ...
    initial_vals = initial_vals.reshape(6, 5)
    print(initial_vals)

    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (5, 4), ['pt', 'rho'], init_params=initial_vals, limits=(-50, 50))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (5, 4), ['pt', 'rho'], limits=(-50, 50))
