...
def get_template(sName, passed, ptbin, obs, syst, muon=False):
    ...
    name = sName+'_'+name+'_'+"jet_pt_soft_wide5"
...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0,120,130,140,150,160,170,180,190,200,225,250,300,400,500,700,900,1200,1500,2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins[20] = {0, 120, 130, 140, 150, 160, 170, 180, 190, 200, 225, 250, 300, 400, 500, 700, 900, 1200, 1500, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 19, widebins, 40, 0, 2000)
...
#	print(mpt[i][2])
    ...
    rpt_TF = TH2F("rpt_TF", "Rho vs. pT Transfer Factor", 40, -7, -2, 40, 0, 2000)
...
#        SF = json.load(f)
    ...
    # TT params
    tqqeffSF = rl.IndependentParameter('tqqeffSF_{}'.format(year), 1., 0, 3)
    tqqnormSF = rl.IndependentParameter('tqqnormSF_{}'.format(year), 1., 0, 3)
    WGeffSF = rl.IndependentParameter('WGeffSF_{}'.format(year), 1., 0, 3)
    WGnormSF = rl.IndependentParameter('WGnormSF_{}'.format(year), 1., 0, 3)
    ZGeffSF = rl.IndependentParameter('ZGeffSF_{}'.format(year), 1., 0, 3)
    ZGnormSF = rl.IndependentParameter('ZGnormSF_{}'.format(year), 1., 0, 3)

    # define bins    
    ptbins = np.array([120,130,140,150,160,170,180,190,200,225,250,300,400,500])
...
#    msdbins = np.linspace(0, 50, 11)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (4, 4), ['pt', 'rho'], init_params=initial_vals, limits=(-50, 50))

    print("Parameter 0 0 value: "+str(tf_MCtempl.parameters[0][0].value))
    print("Parameter 0 1 value: "+str(tf_MCtempl.parameters[0][1].value))
    print("Parameter 0 2 value: "+str(tf_MCtempl.parameters[0][2].value))
    print("Parameter 0 3 value: "+str(tf_MCtempl.parameters[0][3].value))
    print("Parameter 0 4 value: "+str(tf_MCtempl.parameters[0][4].value))
    print("Parameter 1 0 value: "+str(tf_MCtempl.parameters[1][0].value))
    print("Parameter 1 1 value: "+str(tf_MCtempl.parameters[1][1].value))
    print("Parameter 1 2 value: "+str(tf_MCtempl.parameters[1][2].value))
    print("Parameter 1 3 value: "+str(tf_MCtempl.parameters[1][3].value))
    print("Parameter 1 4 value: "+str(tf_MCtempl.parameters[1][4].value))
    print("Parameter 2 0 value: "+str(tf_MCtempl.parameters[2][0].value))
    print("Parameter 2 1 value: "+str(tf_MCtempl.parameters[2][1].value))
    print("Parameter 2 2 value: "+str(tf_MCtempl.parameters[2][2].value))
    print("Parameter 2 3 value: "+str(tf_MCtempl.parameters[2][3].value))
    print("Parameter 2 4 value: "+str(tf_MCtempl.parameters[2][4].value))
    print("Parameter 3 0 value: "+str(tf_MCtempl.parameters[3][0].value))
    print("Parameter 3 1 value: "+str(tf_MCtempl.parameters[3][1].value))
    print("Parameter 3 2 value: "+str(tf_MCtempl.parameters[3][2].value))
    print("Parameter 3 3 value: "+str(tf_MCtempl.parameters[3][3].value))
    print("Parameter 3 4 value: "+str(tf_MCtempl.parameters[3][4].value))
    print("Parameter 4 0 value: "+str(tf_MCtempl.parameters[4][0].value))
    print("Parameter 4 1 value: "+str(tf_MCtempl.parameters[4][1].value))
    print("Parameter 4 2 value: "+str(tf_MCtempl.parameters[4][2].value))
    print("Parameter 4 3 value: "+str(tf_MCtempl.parameters[4][3].value))
    print("Parameter 4 4 value: "+str(tf_MCtempl.parameters[4][4].value))

    tf_MCtempl.parameters[0][3].lo = -1
    tf_MCtempl.parameters[0][3].hi = 1
    tf_MCtempl.parameters[1][3].lo = -1
    tf_MCtempl.parameters[1][3].hi = 1
    tf_MCtempl.parameters[2][3].lo = -1
    tf_MCtempl.parameters[2][3].hi = 1
    tf_MCtempl.parameters[3][0].lo = -1
    tf_MCtempl.parameters[3][0].hi = 1
    tf_MCtempl.parameters[3][1].lo = -1
    tf_MCtempl.parameters[3][1].hi = 1
    tf_MCtempl.parameters[3][2].lo = -1
    tf_MCtempl.parameters[3][2].hi = 1
    tf_MCtempl.parameters[3][3].lo = -1
    tf_MCtempl.parameters[3][3].hi = 1

    tf_MCtempl.parameters[0][4].lo = -1
    tf_MCtempl.parameters[0][4].hi = 1
    tf_MCtempl.parameters[1][4].lo = -1
    tf_MCtempl.parameters[1][4].hi = 1
    tf_MCtempl.parameters[2][4].lo = -1
    tf_MCtempl.parameters[2][4].hi = 1
    tf_MCtempl.parameters[3][4].lo = -1
    tf_MCtempl.parameters[3][4].hi = 1
    tf_MCtempl.parameters[4][0].lo = -1
    tf_MCtempl.parameters[4][0].hi = 1
    tf_MCtempl.parameters[4][1].lo = -1
    tf_MCtempl.parameters[4][1].hi = 1
    tf_MCtempl.parameters[4][2].lo = -1
    tf_MCtempl.parameters[4][2].hi = 1
    tf_MCtempl.parameters[4][3].lo = -1
    tf_MCtempl.parameters[4][3].hi = 1
    tf_MCtempl.parameters[4][4].lo = -1
    tf_MCtempl.parameters[4][4].hi = 1
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (4, 4), ['pt', 'rho'], limits=(-50, 50))

    tf_dataResidual.parameters[0][3].lo = -1
    tf_dataResidual.parameters[0][3].hi = 1
    tf_dataResidual.parameters[1][3].lo = -1
    tf_dataResidual.parameters[1][3].hi = 1
    tf_dataResidual.parameters[2][3].lo = -1
    tf_dataResidual.parameters[2][3].hi = 1
    tf_dataResidual.parameters[3][0].lo = -1
    tf_dataResidual.parameters[3][0].hi = 1
    tf_dataResidual.parameters[3][1].lo = -1
    tf_dataResidual.parameters[3][1].hi = 1
    tf_dataResidual.parameters[3][2].lo = -1
    tf_dataResidual.parameters[3][2].hi = 1
    tf_dataResidual.parameters[3][3].lo = -1
    tf_dataResidual.parameters[3][3].hi = 1

    tf_dataResidual.parameters[0][4].lo = -1
    tf_dataResidual.parameters[0][4].hi = 1
    tf_dataResidual.parameters[1][4].lo = -1
    tf_dataResidual.parameters[1][4].hi = 1
    tf_dataResidual.parameters[2][4].lo = -1
    tf_dataResidual.parameters[2][4].hi = 1
    tf_dataResidual.parameters[3][4].lo = -1
    tf_dataResidual.parameters[3][4].hi = 1
    tf_dataResidual.parameters[4][0].lo = -1
    tf_dataResidual.parameters[4][0].hi = 1
    tf_dataResidual.parameters[4][1].lo = -1
    tf_dataResidual.parameters[4][1].hi = 1
    tf_dataResidual.parameters[4][2].lo = -1
    tf_dataResidual.parameters[4][2].hi = 1
    tf_dataResidual.parameters[4][3].lo = -1
    tf_dataResidual.parameters[4][3].hi = 1
    tf_dataResidual.parameters[4][4].lo = -1
    tf_dataResidual.parameters[4][4].hi = 1
...
#            raise ValueError('initial_Data negative for some bins..', initial_Data)
        ...
        WGpass.setParamEffect(WGeffSF, 1*WGeffSF)
        WGfail.setParamEffect(WGeffSF, (1 - WGeffSF) * WGPF + 1)
        WGpass.setParamEffect(WGnormSF, 1*WGnormSF)
        WGfail.setParamEffect(WGnormSF, 1*WGnormSF)
        ...
        ZGpass.setParamEffect(ZGeffSF, 1*ZGeffSF)
        ZGfail.setParamEffect(ZGeffSF, (1 - ZGeffSF) * ZGPF + 1)
        ZGpass.setParamEffect(ZGnormSF, 1*ZGnormSF)
        ZGfail.setParamEffect(ZGnormSF, 1*ZGnormSF)

        tqqpass = passCh['TTBar']
        tqqfail = failCh['TTBar']
	#print("Top Pass Expectation: "+str(tqqpass.getExpectation(nominal=True).sum()))
	#print("Top Fail Expectation: "+str(tqqfail.getExpectation(nominal=True).sum()))
