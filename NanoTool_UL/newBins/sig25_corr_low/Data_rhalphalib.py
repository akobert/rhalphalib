...
#    msdbins = np.linspace(0, 50, 11)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (2, 2), ['pt', 'rho'], init_params=initial_vals, limits=(-100, 100))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (2, 2), ['pt', 'rho'], limits=(-100, 100))
